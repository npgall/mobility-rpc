...
public class NetworkUtil {
    ...
    public static List<String> getAllNetworkInterfaceAddresses() {
        try {
            ...
            for (Enumeration ifaces = NetworkInterface.getNetworkInterfaces(); ifaces.hasMoreElements();) {
                ...
                for (Enumeration inetAddrs = iface.getInetAddresses(); inetAddrs.hasMoreElements();) {
                    InetAddress inetAddr = (InetAddress) inetAddrs.nextElement();
                    results.add(inetAddr.getHostAddress());
                }
            }
            return results;
        }
        catch (Exception e) {
            throw new IllegalStateException("Failed to determine IP addresses assigned to the network interfaces on this machine", e);
        }
    }
}
